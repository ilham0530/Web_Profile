...
<section class="bg-gray-200 dark:bg-gray-800" id="home-page">
    <div class="w-full mx-auto max-w-screen-xl p-4 lg:py-6">
        <div class="ml-12 sm:ml-14 mt-8 mb-8 flex sm:justify-between">
            <div class="mt-10 sm:mt-32">
                <h1 class="mb-5 sm:mb-9 text-xl sm:text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Hallo,<span class="text-blue-600 dark:text-blue-500"><br>i'm Ilham Maulana </span></h1>
                <a href="#about" class="shadow-lg shadow-gray-900 dark:shadow-yellow-100 inline-flex items-center px-3 py-1 sm:px-5 sm:py-3 text-sm sm:text-base font-medium text-center text-white bg-blue-700 rounded-lg justify-left hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    tentang saya
            ...
            <div class="sm:-mr-10 -mr-28">
                <img class="mx-w-c max-w-c sm:max-w-xl sm:max-h-xl" src="{{ asset('img/Profile (1).png') }}" alt="">
            </div>
        </div>
        ...
        <div id="about" class="mt-0 sm:mt-20">
            ...
            <div class="w-full text-center">
                <h1 class="text-3xl text- font-bold text-gray-900 dark:text-white">Deskripsi Diri</h1>
                ...
                <div id="animation-carousel" class="relative w-full" data-carousel="static">
                    ...
                    <div class="relative h-80 overflow-hidden rounded-lg" style="height:450px">
                        ...
                        <div class="hidden delay-200 ease-linear" data-carousel-item>
                            <div class="grid grid-cols-2 m-10 sm:justify-around sm:flex">
                                <div class="w-full max-w-xs bg-white border border-gray-200 rounded-lg shadow-lg shadow-gray-900 dark:shadow-yellow-100 dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    <div class="px-5 pb-5">
                                        ...
                                        <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="mt-4 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                                            <a href="#portofolio" class="flex">
                                                Selengkapnya
                    ...
                    <button type="button" class="absolute top-0 left-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
                        <span class="inline-flex items-center justify-center w-10 h-10 rounded-full shadow-md shadow-gray-900 dark:shadow-yellow-100 bg-white dark:bg-gray-900 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                            <svg class="w-4 h-4 text-gray-700 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
