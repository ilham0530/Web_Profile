    ...
    <div class="w-full max-w-screen-xl p-4 py-6 mx-auto lg:py-8">
        <div class="md:flex md:justify-between">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Blog</h2>
                ...
                <div>
                    ...
                    <ul class="font-medium text-gray-500 dark:text-gray-400">
                        <li class="mb-4">
                            <a href="https://github.com/IlhamM3" class="hover:underline ">Github</a>
                        </li>
                        <li>
                            <a href="https://discord.gg/Gt6ECDtV" class="hover:underline">Discord</a>
                        </li>
                    </ul>
                </div>
                {{-- <div>
            ...
            <div class="flex mt-4 space-x-5 md:flex md:justify-between sm:justify-center sm:mt-0">
                ...
                <div class="flex mt-4 space-x-5 md:flex md:justify-between sm:justify-center sm:mt-0">
                    <div class="flex space-x-5 sm:flex sm:justify-between sm:items-center">
                        ...
                        <a target="_blank" href="https://dribbble.com/frontam_" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <a target="_blank" href="http://www.linkedin.com/in/ilham-maulana-05er4" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
